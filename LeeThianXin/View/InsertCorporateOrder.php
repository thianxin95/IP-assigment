...
<!--
/**
 * Description of InsertCorporateOrder
 *
 * @author Daniel Lee
 */
-->
    ...
    <body>
        ...
        if (isset($_POST['submit'])) {
            ...
            if ($_POST['submit'] == 'proceedOrder') {
                ...
                if ($_POST['pickup'] == '' || $_POST['deliveryAddress'] == '' || $_POST['requiredate'] == '' || $_POST['PaymentMethod'] == '0') {
        ...
        function insertOrder(OrderOB $newOrder, $ordernewID) {
            ...
            for ($a = 0; $a < count($_SESSION["Selected_itemArray"]); $a++) {
                ...
                if ($GLOBALS['UserID']) {
                    ...
                    $GLOBALS["totalprice"] = $orderDetail->getTotalprice();
                    ...
                    $newOrderDetail = new OrderDetailsOB($newID2, $ordernewID, $code, $quantity, $price);
