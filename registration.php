    ...
    <body>
        ...
        <div class="container-scroller">
            ...
            if (isset($_POST["submit"])) {
                ...
                include_once 'DesignPattern/userProfile.php';
                ...
                $Name = $_POST["name"];
                $useridReg = $_POST["userid"];
                $add = $_POST["address"];
                $phoneNum = $_POST["phone"];
                $email = $_POST["email"];
                $userprofile = new User($useridReg, $typeCus, $Name, $add, $phoneNum, $email, $credit, $usedCredit, $overDue, $saltedPass);
                if ($typeCus == "Customer") {
                    $userprofile->setCreditLimit(0);
                    $userprofile->setUsedCredit(0);
                    $userprofile->setOverDue("no");
                    $productObject = CustomerFactory::Register($userprofile);
                    
                }if($typeCus == "Corporate"){
                   $productObject = CorporateFactory::Register($userprofile);
                }
